...
in ''
  ...
  #
  	...
  	font = "./9xz6bdv0yyzin2qa2pw0w1qy1ygipi8y-noto-64351-tex/fonts/truetype/google/noto/NotoSansMono-Thin.ttf"
  ...
  #
  	...
  	require-match = true
  	# maybe use komma in combination with this, to make unavailable apps available
